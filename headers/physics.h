...
struct Physics
{
	...
	static bool RectVsRect(const olc::utils::geom2d::rect<float>& r1, const olc::utils::geom2d::rect<float>& r2);
	static bool RectVsRect2(olc::utils::geom2d::rect<float> r1_, olc::utils::geom2d::rect<float> r2_);
