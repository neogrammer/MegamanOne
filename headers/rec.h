...
struct rec
{
	...
	void set(olc::vf2d pos_, olc::vf2d size_, Cfg::Textures texType_ = Cfg::Textures::Tileset1, olc::vi2d texRectTilePos_ = { 0,0 }, olc::vi2d texRectSize_ = { 50,50 }, olc::vi2d texOffset_ = { 0,0 }, olc::vf2d vel_ = { 0.f,0.f });
