	...
	: Enemy{ Cfg::Textures::SnailEnemy, { {0,0},{70,46} }, { {15.f,16.f},{20.f,30.f} }, SpriteType::Enemy, { 1300.f, 900.f - 50.f - 30.f }, AnimDirType::Left, false }
{
	...
	this->animMap[std::pair("walk", false)].numFrames = loadAnimation(this->animMap[std::pair("walk", false)].frames, 8, 8, 0, 0, 0);
	...
	this->animMap[std::pair("walk", true)].numFrames = loadAnimation(this->animMap[std::pair("walk", true)].frames, 8, 8, 0, 5, 0);
	...
	this->animMap[std::pair("hide", false)].numFrames = loadAnimation(this->animMap[std::pair("hide", false)].frames, 8, 8, 0, 1, 0);
	...
	this->animMap[std::pair("hide", true)].numFrames = loadAnimation(this->animMap[std::pair("hide", true)].frames, 8, 8, 0, 6, 0);
	...
	this->animMap[std::pair("unhide", false)].numFrames = loadAnimation(this->animMap[std::pair("unhide", false)].frames, 8, 8, 0, 2, 0);
	...
	this->animMap[std::pair("unhide", true)].numFrames = loadAnimation(this->animMap[std::pair("unhide", true)].frames, 8, 8, 0, 7, 0);
	...
	this->animMap[std::pair("die", false)].numFrames = loadAnimation(this->animMap[std::pair("die", false)].frames, 8, 8, 0, 3, 0);
	...
	this->animMap[std::pair("die", true)].numFrames = loadAnimation(this->animMap[std::pair("die", true)].frames, 8, 8, 0, 8, 0);
	...
	this->animMap[std::pair("idle", false)].numFrames = loadAnimation(this->animMap[std::pair("idle", false)].frames, 1, 1, 0, 4, 0);
	...
	this->animMap[std::pair("idle", true)].numFrames = loadAnimation(this->animMap[std::pair("idle", true)].frames, 1, 1, 0, 9, 0);
	...
	this->animMap[std::pair("hit", false)].numFrames = loadAnimation(this->animMap[std::pair("hit", false)].frames, 1, 1, 0, 4, 2);
	...
	this->animMap[std::pair("hit", true)].numFrames = loadAnimation(this->animMap[std::pair("hit", true)].frames, 1, 1, 0, 9, 2);
